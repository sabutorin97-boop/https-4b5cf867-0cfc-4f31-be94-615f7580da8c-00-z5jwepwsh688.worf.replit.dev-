...
(function () {
  ...
  function pickSolution(a) {
    ...
    if (balcony && !has("warm")) {
      profile = "Облегчённый профиль 60 мм";
      ...
      profile = "Шестикамерный профиль 76 мм";
      profileNote = "Широкая монтажная глубина — главный вклад и в тепло, и в защиту от шума.";
    } else {
      profile = "Пятикамерный профиль 70 мм";
      profileNote = "Оптимально для квартиры: заметно теплее старых окон, без переплаты за лишние камеры.";
    }
