  ...
  function pickSolution(a) {
    ...
    if (depth === 58) {
      if (balcony && !wantsWarm) {
        ...
        glassNote = "Максимум, что встаёт в 58-й профиль. Напыление на внутреннем стекле возвращает тепло обратно в комнату — заметно теплее стандартных 24 мм.";
      }
    } else if (depth === 70) {
      if (wantsQuiet) {
        ...
        glassNote = "Широкая камера плюс энергосберегающее напыление — в комнате ощутимо теплее.";
      ...
      if (noisy) {
        ...
        glassNote = "80-й профиль вместе с энергосберегающим пакетом от 42 мм даёт класс энергосбережения А+ — верхний уровень по теплу.";
